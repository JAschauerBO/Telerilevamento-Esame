##' Violin plot of NDVI distributions per date
##'
##' Create violin plots from the `v_ndvi_df` structure. Supports scale adjustments and saving to file.
