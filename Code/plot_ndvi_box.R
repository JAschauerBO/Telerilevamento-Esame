...
ndvi_plot <- ggplot(ndvi_long, aes(x = date_f, y = values, group = date_f)) +
  geom_boxplot(width = 0.6, outlier.shape = NA, fill = "#4C78A8", alpha = 0.22, color = "#2F4B7C", linewidth = 0.6) +
...
ggsave("../Images/ndvi_boxplot.png", plot = ndvi_plot, width = 12, height = 6, dpi = 300)
message("Plot saved to Images/ndvi_boxplot.png")
